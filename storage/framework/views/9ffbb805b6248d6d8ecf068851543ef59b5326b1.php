...
<body>
<form  method="POST" action="<?php echo e(url('/addData')); ?>" >
...
<table>
	<tr>
		<td> 
			...
			<input type="text" name="search" style="width: 400px" class="form-control" id="search" placeholder="请输入用户名或者邮箱或者电话" value="<?php echo e(request('search')); ?>">	 
		</td> 
	</tr> 
	<tr>
